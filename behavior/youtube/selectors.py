...
DESKTOP = {
    ...
    "player_state_classes": {
        ...
        "autohide": '.html5-video-player.ytp-autohide',                  # Controls hidden until hover
        "delhi_modern": '.html5-video-player.ytp-delhi-modern',          # 2025+ compact controls
        "delhi_horizontal_volume": '.html5-video-player.ytp-delhi-horizontal-volume-controls',
    ...
    "autoplay_toggle_button": (
        # Delhi UI: click outer button; aria-checked is on inner div
        'button.ytp-autonav-toggle',
        'button.ytp-autonav-toggle.delhi-fast-follow-autonav-toggle',
        'button[data-tooltip-target-id="ytp-autonav-toggle-button"]',
        'button[aria-label*="Autoplay is" i]',
        'button[aria-label*="Auto-play" i]',
    ),
    "autoplay_state_inner": (
        # aria-checked="true|false" — NOT on the button itself
    ...
    "settings_quality_secondary": (
        '.ytp-menuitem-content .ytp-menu-label-secondary',  # e.g. "(360p)" under Auto
    ),
